...
SWEP.VElements = {
	["redbird"] = { type = "Model", model = "models/svrkdstuff/redbird.mdl", bone = "ValveBiped.Grenade_body", rel = "", pos = Vector(-0.438, 2.71, 0.456), angle = Angle(-133.818, 39.349, -6.362), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_UpperArm"] = { scale = Vector(1, 1, 1), pos = Vector(7.097, 2.565, 2.641), angle = Angle(-11.119, -5.389, -3.043) },
...
function SWEP:PrimaryShoot()
    ...
    if SERVER then
        ...
        timer.Simple(0, function()
            ...
            self:EmitSound("svrkdstuff/red_fly.wav")
