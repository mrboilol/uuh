...
SWEP.Author = "Me"
SWEP.Instructions = "Good scott, Gordon freeman!"
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_smg1.mdl"
SWEP.WorldModelFake = "models/weapons/c_smg1.mdl"
//SWEP.FakeScale = 1.2
...
SWEP.animposmul = 2
SWEP.Primary.Sound = {"weapons/smg1/smg1_fire1.wav", 75, 100, 110}
